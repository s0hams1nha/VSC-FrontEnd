...
def letter(handpoints, image):
    ...
    if(handpoints[8].y > handpoints[5].y and
       ...
       handpoints[4].z > handpoints[8].z and
       handpoints[5].x > handpoints[4].x and
       handpoints[4].x > handpoints[10].x):
    ...
    if(handpoints[0].y>handpoints[1].y and
       ...
       handpoints[8].x<handpoints[4].x):
        cv2.putText(image,"F",(10,30), cv2.FONT_HERSHEY_PLAIN, 2, (0,0,255), 1)
    ...
    if (handpoints[7].y > handpoints[5].y and
        handpoints[5].y > handpoints[6].y and
        handpoints[11].y > handpoints[9].y and
        handpoints[9].y > handpoints[10].y and
        handpoints[16].y > handpoints[15].y and
        ...
        handpoints[20].y > handpoints[19].y and
        handpoints[18].y > handpoints[17].y and
        handpoints[4].z > handpoints[11].z and
        handpoints[11].x > handpoints[4].x and
        handpoints[4].x > handpoints[13].x):
        cv2.putText(image, "N", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5,(0,0,255),1)
    ...
    if(handpoints[7].y > handpoints[5].y and
       ...
       handpoints[20].y > handpoints[18].y and
       handpoints[18].y > handpoints[17].y and
       handpoints[14].x > handpoints[4].x and
       handpoints[4].x > handpoints[17].x and
       handpoints[3].z > handpoints[15].z):
      cv2.putText(image, "M", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5,(0,0,255),1)
